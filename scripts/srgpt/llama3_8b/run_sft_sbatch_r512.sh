...
singularity exec --nv /blue/bianjiang/tienyuchang/anaconda bash scripts/srgpt/llama3_8b/3_sft_medical_r512.sh $STAGE2_PATH $OUTPUT $DATA $EPOCH $OUTPUT_DIR $LR $bs
